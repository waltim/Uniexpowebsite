...
'maxSize' => 2097152, // 2MB
'allowedMime' => array('application/pdf','image/jpeg', 'image/pjpeg', 'image/png', 'image/gif', 'image/bmp', 'image/x-icon', 'image/vnd.microsoft.icon'),
'allowedExt' => array('.pdf','.jpg', '.jpeg', '.png', '.gif', '.bmp', '.ico'),
